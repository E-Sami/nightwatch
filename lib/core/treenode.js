...
class TreeNode {
   ...
   */
  constructor({name, parent, namespace, stackTrace, deferred, isES6Async, compatMode, rejectPromise, addedInsideCallback, suppressedAtScenarioBoundary}) {
    this.__command = null;
    this.__context = null;
    this.__args = null;
    ...
    this.suppressedAtScenarioBoundary = suppressedAtScenarioBoundary;
  }
